<script lang="ts">
	...
	function placeholder(lang: SourceLang) {
		return lang === 'te'
			? 'Telugu word (in Telugu script or English letters)'
			: 'English word';
	}
...
<main>
	<header>
		<h1>Chilaka</h1>
		<p class="tagline">Add a Telugu vocabulary flashcard.</p>
	</header>
	...
	<section class="input">
		...
		>
			<input
				...
				autocapitalize="off"
			/>
			<button type="submit" class="primary" disabled={translating || recording || !textInput.trim()}>
				Translate
			</button>
		</form>
